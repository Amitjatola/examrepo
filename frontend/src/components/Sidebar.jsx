...
import { LayoutDashboard, BookOpen, Lightbulb, History, GraduationCap, LogOut, LogIn, Tag, Info } from 'lucide-react';
import { useAuth } from '../context/AuthContext';

const Sidebar = ({ activeTab, onTabChange, onOpen = () => { }, isOpen = true, onLogoClick }) => {
    ...
    return (
        <aside className="fixed inset-y-0 left-0 bg-white dark:bg-[#101323] border-r border-[#f0f2f4] dark:border-border-dark flex flex-col justify-between z-20 w-72 transition-transform duration-300">
            <div className="flex flex-col p-6 flex-1">
                {/* Logo - Clickable to go to landing page */}
                <button
                    onClick={onLogoClick}
                    className="flex items-center gap-3 mb-8 cursor-pointer hover:opacity-80 transition-opacity text-left"
                >
